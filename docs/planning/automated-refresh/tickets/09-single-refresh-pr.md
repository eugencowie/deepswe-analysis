...
This reverses ticket 08's two-jobs-two-PRs decision. Its reasons and why they no longer hold:
...
- `workflow_dispatch` still runs both halves with no input (ticket 08 decision stands).
