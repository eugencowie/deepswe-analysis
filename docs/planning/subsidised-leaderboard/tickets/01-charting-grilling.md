...
- Hosting: **GitHub Pages** via a GitHub Actions workflow. Public repo `deepswe-enhanced` (no remote exists yet; creation is build-phase work for the spec to cover).
